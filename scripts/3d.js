...
// init function triggered on page load to set the body height to enable scrolling and EffectCanvas initialized
function init() {
...
class EffectCanvas {
    ...
    onWindowResize() {
        ...
        this.camera.updateProjectionMatrix(); // Used to recalculate project in dimensions.
...
class MeshItem {
    ...
    render() {
        ...
        this.mesh.position.set(this.offset.x, this.offset.y, 0)
        this.mesh.scale.set(this.sizes.x, this.sizes.y, 1)
        this.uniforms.uOffset.value.set(this.offset.x * 0.0, -(target - current) * 0.00025)
    }
}
